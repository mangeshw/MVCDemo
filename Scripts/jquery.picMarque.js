...
(function($) {
  $.fn.picMarque = function(t) {
    var n = {speed: 100,data:[], errorimg:'http://www.siaa.org.cn/style/common/nophoto.jpg'};
    var r = $.extend(n, t);
    var data = n.data;
    ...
    for(var i=0;i<data.length;i++){
      if(i>=5) break;
      html += '<li><a href="' + data[i].link + '"><img src="' + data[i].image + '" alt="' + data[i].title
          + '" onerror="this.src=\'' + n.errorimg + '\'"></a><div class="splendid-links">' + data[i].title
          + '</div></li>';
    }
